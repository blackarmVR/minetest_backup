...
# copy map file to website
cp /home/mineclone2/.minetest/worlds/backup/map.sqlite /var/www/html/
...
find /home/mineclone2/minetest_backups -type f -name '*.tar.gz' -mtime +3 -exec rm {} \;
